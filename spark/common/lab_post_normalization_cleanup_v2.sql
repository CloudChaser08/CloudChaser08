DROP TABLE IF EXISTS lab_clean;
CREATE TABLE lab_clean AS SELECT
    ...
    cap_year_of_birth(
        patient_age, date_service, patient_year_of_birth
...
ALTER TABLE lab_clean RENAME TO lab_common_model;
