...
schema = Schema(
    ...
    output_directory='ccf/2021-08-31/patient_problem/',
    ...
    schema_structure=StructType([
        ...
        StructField('prob_concept_name', StringType(), True),
        StructField('prob_code', StringType(), True),
        StructField('prob_code_system_name', StringType(), True),
        StructField('source_prob_code', StringType(), True),
        StructField('source_prob_code_system_name', StringType(), True),
        StructField('source_prob_desc', StringType(), True),
        StructField('problem_type', StringType(), True),
        StructField('problem_start_date', StringType(), True),
        StructField('problem_end_date', StringType(), True),
        StructField('primary_secondary', StringType(), True),
