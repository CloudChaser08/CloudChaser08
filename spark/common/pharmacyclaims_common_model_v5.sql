...
CREATE {external} TABLE {table_name} (
	...
	cob_count                                  string,
	usual_and_customary_charge                 currency,
	product_selection_attributed               currency,
	other_payer_recognized                     currency,
	periodic_deductible_applied                currency,
	periodic_benefit_exceed                    currency,
	accumulated_deductible                     currency,
	remaining_deductible                       currency,
	remaining_benefit                          currency,
	copay_coinsurance                          currency,
	basis_of_cost_determination                currency,
	submitted_ingredient_cost                  currency,
	submitted_dispensing_fee                   currency,
	submitted_incentive                        currency,
	submitted_gross_due                        currency,
	submitted_professional_service_fee         currency,
	submitted_patient_pay                      currency,
	submitted_other_claimed_qual               currency,
	submitted_other_claimed                    currency,
	basis_of_reimbursement_determination       currency,
	paid_ingredient_cost                       currency,
	paid_dispensing_fee                        currency,
	paid_incentive                             currency,
	paid_gross_due                             currency,
	paid_professional_service_fee              currency,
	paid_patient_pay                           currency,
	paid_other_claimed_qual                    currency,
	paid_other_claimed                         currency,
	tax_exempt_indicator                       string,
	coupon_type                                string,
	coupon_number                              string,
	coupon_value                               currency,
