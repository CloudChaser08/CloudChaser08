...
schema = StructType([
    ...
    StructField('procedure_units_billed',             DoubleType(),  True),
    StructField('procedure_units_paid',               DoubleType(),  True),
    ...
    StructField('claim_transaction_amount',           DoubleType(),  True),
