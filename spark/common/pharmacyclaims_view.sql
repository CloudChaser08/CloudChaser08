...
WHERE part_provider IN ('apothecary_by_design', 'genoa', 'mckesson_macro_helix', 'cardinal_pds')
UNION ALL
    SELECT record_id,
    claim_id,
    hvid,
...
WHERE part_provider IN ('mckesson', 'mckesson_res', 'diplomat', 'cardinal_vitalpath')
UNION ALL
