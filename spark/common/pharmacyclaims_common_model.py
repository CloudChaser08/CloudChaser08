...
schema_v6 = StructType([
    ...
    StructField('fill_number', IntegerType(), True),
    StructField('refill_auth_amount', StringType(), True),
    StructField('dispensed_quantity', FloatType(), True),
    StructField('unit_of_measure', StringType(), True),
    StructField('days_supply', IntegerType(), True),
    StructField('pharmacy_npi', StringType(), True),
    StructField('prov_dispensing_npi', StringType(), True),
    ...
    StructField('result_of_service_code', StringType(), True),
    StructField('prov_prescribing_npi', StringType(), True),
    StructField('prov_prescribing_tax_id', StringType(), True),
    StructField('prov_prescribing_dea_id', StringType(), True),
    StructField('prov_prescribing_ssn', StringType(), True),
    StructField('prov_prescribing_state_license', StringType(), True),
    StructField('prov_prescribing_upin', StringType(), True),
    StructField('prov_prescribing_commercial_id', StringType(), True),
    StructField('prov_prescribing_name_1', StringType(), True),
    StructField('prov_prescribing_name_2', StringType(), True),
    StructField('prov_prescribing_address_1', StringType(), True),
    StructField('prov_prescribing_address_2', StringType(), True),
    StructField('prov_prescribing_city', StringType(), True),
    StructField('prov_prescribing_state', StringType(), True),
    StructField('prov_prescribing_zip', StringType(), True),
    StructField('prov_prescribing_std_taxonomy', StringType(), True),
    StructField('prov_prescribing_vendor_specialty', StringType(), True),
    StructField('prov_primary_care_npi', StringType(), True),
    StructField('cob_count', StringType(), True),
    StructField('usual_and_customary_charge', DoubleType(), True),
    StructField('product_selection_attributed', DoubleType(), True),
...
schema_v7 = StructType([
    ...
    StructField('prov_primary_care_npi', StringType(), True),
    StructField('cob_count', StringType(), True),
    StructField('usual_and_customary_charge', FloatType(), True),
    StructField('product_selection_attributed', FloatType(), True),
    StructField('other_payer_recognized', FloatType(), True),
    StructField('periodic_deductible_applied', FloatType(), True),
    StructField('periodic_benefit_exceed', FloatType(), True),
    StructField('accumulated_deductible', FloatType(), True),
    StructField('remaining_deductible', FloatType(), True),
    StructField('remaining_benefit', FloatType(), True),
    StructField('copay_coinsurance', FloatType(), True),
    StructField('basis_of_cost_determination', StringType(), True),
    StructField('submitted_ingredient_cost', FloatType(), True),
    StructField('submitted_dispensing_fee', FloatType(), True),
    StructField('submitted_incentive', FloatType(), True),
    StructField('submitted_gross_due', FloatType(), True),
    StructField('submitted_professional_service_fee', FloatType(), True),
    StructField('submitted_patient_pay', FloatType(), True),
    StructField('submitted_other_claimed_qual', FloatType(), True),
    StructField('submitted_other_claimed', FloatType(), True),
    StructField('basis_of_reimbursement_determination', StringType(), True),
    StructField('paid_ingredient_cost', FloatType(), True),
    StructField('paid_dispensing_fee', FloatType(), True),
    StructField('paid_incentive', FloatType(), True),
    StructField('paid_gross_due', FloatType(), True),
    StructField('paid_professional_service_fee', FloatType(), True),
    StructField('paid_patient_pay', FloatType(), True),
    StructField('paid_other_claimed_qual', FloatType(), True),
    StructField('paid_other_claimed', FloatType(), True),
    StructField('tax_exempt_indicator', StringType(), True),
    StructField('coupon_type', StringType(), True),
    StructField('coupon_number', StringType(), True),
    StructField('coupon_value', FloatType(), True),
    StructField('pharmacy_other_id', StringType(), True),
    StructField('pharmacy_other_qual', StringType(), True),
    StructField('pharmacy_postal_code', StringType(), True),
    StructField('prov_dispensing_id', StringType(), True),
    ...
    StructField('other_payer_date', DateType(), True),
    StructField('other_payer_coverage_code', StringType(), True),
    StructField('logical_delete_reason_date', DateType(), True),
    StructField('logical_delete_reason', StringType(), True)
])
...
schema_v9 = StructType([
    ...
    StructField('other_payer_date', DateType(), True),
    StructField('other_payer_coverage_code', StringType(), True),
    StructField('pharmacy_claim_link_text', StringType(), True),
    StructField('logical_delete_reason_date', DateType(), True),
    StructField('logical_delete_reason', StringType(), True)
])
...
schema_v11 = StructType([
    ...
    StructField('pharmacy_other_qual', StringType(), True),
    StructField('pharmacy_postal_code', StringType(), True),
    StructField('pharmacy_group', StringType(), True),
    StructField('prov_dispensing_id', StringType(), True),
    StructField('prov_dispensing_qual', StringType(), True),
    StructField('prov_prescribing_id', StringType(), True),
    StructField('prov_prescribing_qual', StringType(), True),
