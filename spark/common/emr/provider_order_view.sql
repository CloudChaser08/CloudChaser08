...
CREATE VIEW dw.hvm_emr_prov_ord (
        ...
        ordg_prov_state_cd,
        ordg_prov_zip_cd,
        ordg_fclty_taxnmy_id,
        ordg_fclty_speclty_id,
        ordg_fclty_state_cd,
        ordg_fclty_zip_cd,
        prov_ord_start_dt,
        prov_ord_end_dt,
    ...
    ordg_prov_state_cd,
    ordg_prov_zip_cd,
    COALESCE(ordg_fclty_nucc_taxnmy_cd, ordg_fclty_alt_taxnmy_id),
    COALESCE(ordg_fclty_mdcr_speclty_cd, ordg_fclty_alt_speclty_id),
    ordg_fclty_state_cd,
    ordg_fclty_zip_cd,
    prov_ord_start_dt,
    prov_ord_end_dt,
