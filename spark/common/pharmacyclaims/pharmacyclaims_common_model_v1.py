"""pharmacyclaims common model v1"""
...
schema = Schema(
    ...
    output_directory='pharmacyclaims/2017-02-28',
    ...
    schema_structure=StructType([
        ...
        StructField('submitted_flat_sales_tax', DoubleType(), True),
        StructField('submitted_percent_sales_tax_basis', DoubleType(), True),
        StructField('submitted_percent_sales_tax_rate', DoubleType(), True),
        StructField('submitted_percent_sales_tax_amount', DoubleType(), True),
