...
--    delta.acct_number	                                                                   AS client_acct_number
     ...
     -------DIAG
    rslt.s_diag_code_codeset_ind,
    rslt.HV_s_diag_code_codeset_ind,
    -------PHY
    rslt.c_phy_last_name AS phy_last_name,
    rslt.c_phy_first_name AS phy_first_name,
    rslt.c_phy_middle_name AS phy_middle_name,
    -------UDF Result Value
    rslt.HV_result_value_operator,
    rslt.HV_result_value_numeric,
    rslt.HV_result_value_alpha,
    rslt.HV_result_value,
    -------QTIM
    rslt.profile_name_qtim,
    rslt.order_name_qtim,
    rslt.specimen_type_desc_qtim,
    rslt.methodology_qtim,
    rslt.result_name_qtim,
    rslt.unit_of_measure_qtim,
    rslt.loinc_number_qtim,
    ------------------ CMDM
    rslt.hv_provider_name_cmdm,
    rslt.hv_ind_spclty_tp_cmdm,
    rslt.hv_ind_spclty_cd_cmdm,
    rslt.hv_ind_spclty_desc_cmdm,
    rslt.hv_ind_spclty_tp2_cmdm,
    rslt.hv_ind_spclty_cd2_cmdm,
    rslt.hv_ind_spclty_desc2_cmdm,
    rslt.hv_ind_spclty_tp3_cmdm,
    rslt.hv_ind_spclty_cd3_cmdm,
    rslt.hv_ind_spclty_desc3_cmdm,
    rslt.hv_act_spclty_tp_cmdm,
    rslt.hv_act_spclty_cd_cmdm,
    rslt.hv_act_spclty_desc_cmdm,
    -------delta
    rslt.client_acct_number
FROM
--order_result rslt
labtest_quest_rinse_census_pre_final_00 rslt
----------------------UDF
--LEFT OUTER JOIN result_value_lkp rvlkp ON rslt.result_value = rvlkp.result_value
----------------------diag_code_r2c
