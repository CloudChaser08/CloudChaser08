...
class ComplexExampleCensusDriver(CensusDriver):
    ...
    def __init__(self, end_to_end_test=False):
        super(ComplexExampleCensusDriver, self).__init__(
        ...
        self.output_file_name_template = self.OUTPUT_FILE_NAME_TEMPLATE
    ...
    def save(self, dataframe, batch_date, batch_id, chunk_idx=None, header=True):
        ...
        normalized_records_unloader.unload_delimited_file(
            ...
            'deliverable',
            output_file_name=self.output_file_name_template.format(batch_date.year, batch_date.month, batch_date.day)
        )
