SELECT 
    ...
    /* procedure_code_qual */
    CASE 
        WHEN prc.proc_cd_qual IN ('CPTCODE', 'HCPCS') THEN 'HC'
    ...
    CASE 
        WHEN prc.proc_stat_cd IS NOT NULL 
         AND prc.rec_stat_cd IS NOT NULL
...
(
 ...
 LEFT OUTER JOIN dw.hvm_emr_proc_v10 prc 
   ON prc.part_hvm_vdr_feed_id = '25'
  ...
  AND COALESCE(prc.hv_enc_id, 'EMPTY') = COALESCE(enc.hv_enc_id, 'UNPOPULATED')
