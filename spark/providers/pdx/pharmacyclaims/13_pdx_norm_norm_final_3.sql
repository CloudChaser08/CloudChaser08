SELECT
    ...
    created,
	model_version,
	/* This is a mixture of the original dataset name from the initial load */
	/* and a NULL dataset name dummied up for the newly normalized data. */
	/* The NULLs must be replaced with the actual dataset name. */
	data_set,
	data_feed,
	data_vendor,
	patient_gender,
