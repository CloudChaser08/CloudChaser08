...
NULL,
NULL,
upper(regexp_replace(regexp_replace(regexp_replace(split(diag_concat,':')[n-1], ' ', ''), ',', ''), '\\.', '')) AS diagnosis_code,
CASE WHEN diagnosis_code_qual = '9' THEN '01' WHEN diagnosis_code_qual = 'X' THEN '02' END,
NULL,
...
NULL,
NULL,
upper(regexp_replace(regexp_replace(split(unrelated,':')[n-1], ' ', ''), ',', '')) AS procedure_code,
NULL,
