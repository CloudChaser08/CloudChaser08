...
payer_name,
payer_vendor_id,
CASE WHEN place_of_service_std_id IS NOT NULL AND LENGTH(TRIM(place_of_service_std_id)) THEN place_of_service_std_id ELSE substring(inst_type_of_bill_std_id , 1, 2) END as place_of_service_std_id,
procedure_code,
procedure_code_qual,
