  ...
  OR EXISTS
    (
        ...
        WHERE COALESCE(rv1.logical_delete_reason, '') = 'Reversed Claim'
          ...
          AND COALESCE(hst.pharmacy_npi, '') = COALESCE(rv1.pharmacy_npi, '')
          AND COALESCE(hst.ndc_code, '') = COALESCE(rv1.ndc_code, '')
          AND COALESCE(hst.bin_number, '') = COALESCE(rv1.bin_number, '')
          AND COALESCE(CAST(hst.fill_number AS INT), '') = COALESCE(CAST(rv1.fill_number AS INT), '')
    )
  /* Check to see if there's already a Reversed Claim that matches this row */
  ...
  OR EXISTS
    (
        ...
        WHERE COALESCE(rv2.logical_delete_reason, '') = 'Reversed Claim'
          ...
          AND COALESCE(hst.pharmacy_npi, '') = COALESCE(rv2.pharmacy_npi, '')
          AND COALESCE(hst.ndc_code, '') = COALESCE(rv2.ndc_code, '')
          AND COALESCE(hst.bin_number, '') = COALESCE(rv2.bin_number, '')
          AND COALESCE(CAST(hst.fill_number AS INT), '') = COALESCE(CAST(rv2.fill_number AS INT), '')
    )
