SELECT
    ...
    COALESCE(rendering_claim.npi, supervising_claim.npi,
        operating_claim.npi, purchased_claim.npi, other_claim.npi)
...
FROM transactional_header header 
    ...
    -- diag
    LEFT JOIN remaining_diagnosis diagnosis ON diagnosis.claimid = header.claimid
WHERE header.type = 'Professional'
    AND diagnosis.diagnosiscode IS NOT NULL
    AND diagnosis.claimid IS NOT NULL
