...
CREATE EXTERNAL TABLE d_procedure {
        ...
        procedure_effective_date         string,
        procedure_expiration_date        string,
        procedure_hcpcs                  string,
        procedure_cpt                    string,
        procedure_ada                    string,
        procedure_ndc                    string,
        procedure_revenue_code           string,
        procedure_type_of_service        string,
        procedure_audit_created          string,
        procedure_audit_modified         string,
        procedure_audit_created_by_key   string,
        procedure_audit_modified_by_key  string,
