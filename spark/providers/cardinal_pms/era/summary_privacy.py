...
columns_to_nullify = [
    'bllg_prov_npi', 'bllg_prov_vdr_id', 'bllg_prov_tax_id', 'bllg_prov_1_nm', 'bllg_prov_addr_1_txt',
    'bllg_prov_addr_2_txt', 'bllg_prov_city_nm', 'bllg_prov_state_cd', 'bllg_prov_zip_cd', 'rndrg_prov_npi',
    'rndrg_prov_vdr_id', 'rndrg_prov_tax_id', 'rndrg_prov_ssn', 'rndrg_prov_state_lic_id', 'rndrg_prov_upin',
