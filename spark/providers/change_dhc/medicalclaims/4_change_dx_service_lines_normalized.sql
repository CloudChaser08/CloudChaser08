SELECT DISTINCT
    ...
    -- sln.service_line_charge_amount                                                          AS linecharges,
...
FROM change_dx_service_lines sln
LEFT OUTER JOIN change_dx_claims clm ON clm.claim_tcn_id = sln.claim_number
