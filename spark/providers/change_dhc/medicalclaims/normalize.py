...
if __name__ == "__main__":
    ...
    provider_name = 'change_dhc'
    output_table_names_to_schemas = {
        'change_dx_claims_normalized': dhc_medicalclaims_schemas['claims_schema_v1'],
        'change_dx_service_lines_normalized': dhc_medicalclaims_schemas['service_lines_schema_v1']
    }
