...
SELECT DISTINCT
    ...
    END,                                                                              -- date_service_end
    extract_date(transactional.admsn_dt, '%Y%m%d', null, cast({max_date} as date)),   -- inst_date_admitted
    extract_date(transactional.dischg_dt, '%Y%m%d', null, cast({max_date} as date)),  -- inst_date_discharged
