...
if [ -z $4 ] || [ $1 = "-h" ]
then
    echo "usage: ./generate_stats.sh [quarter] [start_date] [end_date] [output_dir] (index_all_dates)"
    exit 0
fi
