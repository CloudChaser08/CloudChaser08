...
def publish(refresh_time_id, requested_list_of_months, output_to_transform_path, conf_parameters,
            test=False):
    """
    ...
    if not output_to_transform_path:
        ...
        logger.log(
            ' -publish:  Update Log and Repair Covid'
            ' table- steps are skipped for transform location')
