...
"""
DATA_TYP = 'DATAMART'
DATAMART_NAME = 'LAB-COVID19-CUSTOM-2022'
REFRESH_IND = 'D'
DATAMART_SHORT_NOTES = 'Lab-Covid19-Custom 2022 Fact, Ref. and Summary -tests and results'

# Final s3 output Path
PRODUCTION = 's3://salusv/warehouse/'
TRANSFORM = 's3://salusv/warehouse/transformed/'
LAB_DATAMART_PATH = 'datamart/covid19_custom2022/lab/'
LAB_DATAMART_STAGE_PATH = 'datamart/covid19_custom2022/lab/_stage/'
LAB_DATAMART_ARCHIVE_PATH = 'datamart/archive/covid19_custom2022/lab/'
...
"""
LAB_PART_PROVIDER_LIST = ['quest_rinse', 'bioreference', 'ovation', 'luminate', 'labcorp_covid']
...
"""
LAB_BIG_PART_PROVIDER = ['quest_rinse']
...
LAB_DW_COVID_CLEANSED_TABLE_NAME_CUSTOM = 'lab_fact_covid_cleansed_custom2022'
LAB_DW_COVID_CLEANSED_DB_TABLE_NAME_CUSTOM = 'dw.lab_fact_covid_cleansed_custom2022'
...
LAB_FACT_ALL_TESTS_CUSTOM = 'lab_fact_all_tests_custom2022'
LAB_FACT_COVID_TESTS_CUSTOM = 'lab_fact_covid_tests_custom2022'
LAB_FACT_COVID_CLEANSED_CUSTOM = 'lab_fact_covid_cleansed_custom2022'
LAB_REF_COVID_CUSTOM = 'lab_ref_covid_custom2022'
LAB_COVID_SNAPSHOT_CUSTOM = 'lab_fact_covid_snapshot_custom2022'
LAB_COVID_SUM_CUSTOM = 'lab_covid_sum_custom2022'
...
s3a://salusv/warehouse/
                    datamart/covid19_custom2022/lab/
                        lab_fact_all_tests/part_mth=<part_mth>/part_provider=<part_provider>/
                        lab_fact_all_tests_custom2022/part_mth=<part_mth>/part_provider=<part_provider>/
                        lab_fact_covid_tests_custom2022/part_mth=<part_mth>/part_provider=<part_provider>/
                        lab_fact_covid_cleansed_custom2022/part_mth=<part_mth>/part_provider=<part_provider>/
                        lab_ref_covid_custom2022/
                        lab_fact_covid_snapshot_custom2022/
                        lab_covid_sum_custom2022/
"""
