...
DAG_NAME = 'cardinal_rcm_dx_pipeline'
...
if HVDAG.HVDAG.airflow_env == 'test':
    S3_TRANSACTION_RAW_URL = 's3://salusv/testing/dewey/airflow/e2e/cardinal_rcm/medicalclaims/raw/'
    S3_TRANSACTION_PROCESSED_URL_TEMPLATE = 's3://salusv/testing/dewey/airflow/e2e/cardinal_rcm/medicalclaims/out/{}/{}/{}/'
    S3_PAYLOAD_DEST = 's3://salusv/testing/dewey/airflow/e2e/cardinal_rcm/medicalclaims/payload/'
else:
    S3_TRANSACTION_RAW_URL = 's3://healthverity/incoming/cardinal/'
    S3_TRANSACTION_PROCESSED_URL_TEMPLATE = 's3://salusv/incoming/medicalclaims/cardinal_rcm/{}/{}/{}/'
    S3_PAYLOAD_DEST = 's3://salusv/matching/payload/medicalclaims/cardinal_rcm/'

# Transaction Addon file
TRANSACTION_TMP_PATH_TEMPLATE = TMP_PATH_TEMPLATE + 'raw/'
TRANSACTION_FILE_DESCRIPTION = 'Cardinal RCM DX transaction file'
TRANSACTION_FILE_NAME_TEMPLATE = 'RCM_Claims_{}.open'

# Deid file
DEID_FILE_DESCRIPTION = 'Cardinal RCM DX deid file'
DEID_FILE_NAME_TEMPLATE = 'RCM_Claims_{}.DeID'
...
detect_move_normalize_dag = SubDagOperator(
    subdag=detect_move_normalize.detect_move_normalize(
        ...
        mdag.schedule_interval,
        {
            ...
            'pyspark_normalization_script_name' : '/home/hadoop/spark/providers/cardinal_rcm/medicalclaims/sparkNormalizeCardinalRcmDX.py',
