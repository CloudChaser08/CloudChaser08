...
if HVDAG.HVDAG.airflow_env == 'test':
    S3_TRANSACTION_RAW_URL = 's3://salusv/testing/dewey/airflow/e2e/mckesson_macro_helix/pharmacyclaims/raw/'
    S3_TRANSACTION_PROCESSED_URL_TEMPLATE = 's3://salusv/testing/dewey/airflow/e2e/mckesson_macro_helix/out/{}/{}/{}/'
    S3_PAYLOAD_DEST = 's3://salusv/testing/dewey/airflow/e2e/mckesson_macro_helix/payload/'
else:
    S3_TRANSACTION_RAW_URL = 's3://healthverity/incoming/mckessonrx/'
    S3_TRANSACTION_PROCESSED_URL_TEMPLATE = 's3://salusv/incoming/pharmacyclaims/mckesson_macro_helix/{}/{}/{}/'
    S3_PAYLOAD_DEST = 's3://salusv/matching/payload/pharmacyclaims/mckesson_macro_helix/'

# Transaction Addon file
TRANSACTION_TMP_PATH_TEMPLATE = TMP_PATH_TEMPLATE + 'raw/'
TRANSACTION_FILE_DESCRIPTION = 'McKesson Macro Helix file'
TRANSACTION_FILE_NAME_TEMPLATE = 'MHHealthVerity.Record.{}{}{}'

# Deid file
DEID_FILE_DESCRIPTION = 'McKesson Macro Helix deid file'
DEID_FILE_NAME_TEMPLATE = 'MHHealthVerity.DEID.{}{}{}'
    ...
    return SubDagOperator(
        subdag=s3_validate_file.s3_validate_file(
            ...
            mdag.schedule_interval,
            {
                ...
                'file_description'        : 'McKesson Macro Helix ' + task_id + ' file'
            }
        ),
...
def norm_args(ds, k):
    base = ['--date', date_utils.insert_date_into_template('{}-{}-{}', k), '--unrestricted']
    if HVDAG.HVDAG.airflow_env == 'test':
        base += ['--airflow_test']
