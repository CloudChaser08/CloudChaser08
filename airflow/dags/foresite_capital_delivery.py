...
DAG_NAME='foresite_capital_delivery'

EMR_CLUSTER_NAME='delivery_cluster-foresite_capital'
NUM_NODES=5
...
run_pyspark_export_routine = PythonOperator(
    ...
    op_kwargs={
        'pyspark_script_name' : '/home/airflow/spark/delivery/foresite_hv000321/sparkExtractForesite.py',
