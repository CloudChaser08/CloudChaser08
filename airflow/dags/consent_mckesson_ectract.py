...
EXPORT_S3_PATH = 's3://healthverityconsent/mckesson/outgoing/1234/'
...
get_tmp_dir = date_utils.generate_insert_date_into_template(TMP_PATH_TEMPLATE)
...
run_export = BashOperator(
    task_id='run_export',
    bash_command='curl -X post http://consent-amgen.aws.healthverity.com:8080/export/1234',
    dag=mdag
)
...
def do_deliver_extracted_data(ds, **kwargs):
    sftp_config = json.loads(Variable.get('consent_mckesson_sftp_configuration'))
