...
aws_env = os.environ
aws_env["AWS_ACCESS_KEY_ID"] = Variable.get("AWS_ACCESS_KEY_ID"),
aws_env["AWS_SECRET_ACCESS_KEY"] = Variable.get("AWS_SECRET_ACCESS_KEY"),
...
#
EMR_APPLICATIONS = (
    "Name=Hadoop Name=Hive Name=Presto Name=Ganglia Name=Spark"
)
