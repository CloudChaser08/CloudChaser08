...
S3_EMDEON_MATCHING = 's3://salusv/matching/payload/medicalclaims/emdeon/'
...
enqueue_psql_script('normalize_professional_claims.sql')
enqueue_psql_script('normalize_institutional_claims.sql')
