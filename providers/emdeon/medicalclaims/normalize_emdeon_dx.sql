...
place_of_service_std_id,
service_line_number,
upper(btrim(split_part(split_part(related,':',n),'_',1))) as diagnosis_code,
diagnosis_code_qual,
...
inst_type_of_bill_std_id,
inst_drg_std_id,
UPPER(BTRIM(split_part(unrelated,':',n))) AS diagnosis_code,
diagnosis_code_qual,
medical_coverage_type,
total_charge,
total_allowed,
...
inst_drg_std_id,
place_of_service_std_id,
UPPER(BTRIM(split_part(diag_concat,':',n))) AS diagnosis_code,
diagnosis_code_qual,
...
inst_drg_std_id,
diagnosis_code_qual,
UPPER(BTRIM(split_part(unrelated,':',n))) AS procedure_code,
