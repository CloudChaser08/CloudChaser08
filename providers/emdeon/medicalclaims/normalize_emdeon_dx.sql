...
UPPER(LTRIM(RTRIM(procedure_code))) AS procedure_code,
procedure_code_qual,
CASE WHEN LEN(UPPER(LTRIM(RTRIM(procedure_code)))) AND UPPER(LTRIM(RTRIM(procedure_code))) = UPPER(LTRIM(RTRIM(principal_procedure))) THEN 1 ELSE NULL END AS principal_proc_ind,
procedure_units,
procedure_modifier_1,
procedure_modifier_2,
procedure_modifier_3,
...
CASE WHEN LEN(UPPER(LTRIM(RTRIM(split_part(unrelated,':',n))))) AND UPPER(LTRIM(RTRIM(split_part(unrelated,':',n)))) = UPPER(LTRIM(RTRIM(principal_procedure))) THEN 1 ELSE NULL END AS principal_proc_ind,
medical_coverage_type,
total_charge,
total_allowed,
prov_rendering_npi,
