...
CREATE TABLE IF NOT EXISTS express_scripts_rx_raw_all (like express_scripts_rx_raw);
INSERT INTO express_scripts_rx_raw_all SELECT * FROM express_scripts_rx_raw;
