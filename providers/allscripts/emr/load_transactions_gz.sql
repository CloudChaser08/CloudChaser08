...
-- COPY transactional_allergies FROM :transactional_allergies_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
-- COPY transactional_appointments FROM :transactional_appointments_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_encounters FROM :transactional_encounters_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_medications FROM :transactional_medications_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_orders FROM :transactional_orders_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_patients FROM :transactional_patients_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_problems FROM :transactional_problems_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
-- COPY transactional_providers FROM :transactional_providers_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_results FROM :transactional_results_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
COPY transactional_vaccines FROM :transactional_vaccines_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
...
-- COPY transactional_vitals FROM :transactional_vitals_input_path CREDENTIALS :credentials EMPTYASNULL GZIP DELIMITER '|';
