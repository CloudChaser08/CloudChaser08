...
COPY transactional_header_dupes FROM :header_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS DELIMITER '|';
...
COPY transactional_serviceline_dupes FROM :serviceline_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS IGNOREHEADER 1 MAXERROR 500 DELIMITER '|';
...
COPY transactional_servicelineaffiliation_dupes FROM :servicelineaffiliation_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS IGNOREHEADER 1 MAXERROR 100 DELIMITER '|';
...
COPY transactional_diagnosis_dupes FROM :diagnosis_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS IGNOREHEADER 1 MAXERROR 100 DELIMITER '|';
...
COPY transactional_procedure_dupes FROM :procedure_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS IGNOREHEADER 1 DELIMITER '|';
...
COPY transactional_billing_dupes FROM :billing_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS IGNOREHEADER 1 DELIMITER '|';
...
COPY transactional_payer_dupes FROM :payer_path CREDENTIALS :credentials EMPTYASNULL ACCEPTINVCHARS DELIMITER '|';
